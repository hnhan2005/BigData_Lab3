...
- Report scientific expansion: Reworked Task 1-1, 1-2, 2-1 and 2-2 with formal input/output definitions, algorithm narrative, source-file responsibilities, mathematical justification, complexity analysis, validation and evidence-based results. Updated Task 2-1 plan counts and Task 2-2 benchmark values to the latest evidence.
- Evidence README expansion: Reworked `docs/evidence/task21/README.md` and `docs/evidence/task22/README.md` with scientific evidence purpose, experimental provenance, file-level descriptions, reproduction commands, reading procedures, report usage and interpretation limits.
